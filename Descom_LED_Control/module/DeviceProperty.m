...
//        NSLog(@"Load config from %@",configPath);
//        _config = [[NSMutableDictionary alloc] initWithContentsOfFile:configPath];
...
//
//        NSLog(@"Load config from %@",plistPath);
//        _config = [[NSMutableDictionary alloc] initWithContentsOfFile:plistPath];
...
//    Device *device3 = [[Device alloc] initWithName:3 name:@"房间4" it:0 type:2 sid:@"7777777777" pwd:@"88888888" ipaddr:@"192.168.10.106" maddr:@"eeeeeeeeee" md:0 st:0 to:232 tc:23443434];
//    
//    NSMutableDictionary *node3 = [self saveDeviceDictionary:device3];
//    [devicelist addObject:node3];
//    [device3 release];
...
//    NSString *configPath = [[NSBundle mainBundle] pathForResource:_name ofType:@"plist"];
//    
//    NSLog(@"write config to path: %@",configPath);
//    
//    [_config writeToFile:configPath atomically:YES];
    ...
    NSLog(@"write config to path: %@",plistPath);
    if(plistData) {  
