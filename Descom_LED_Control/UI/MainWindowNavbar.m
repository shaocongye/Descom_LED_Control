...
@interface MainWindowNavbar()

@property (nonatomic,strong)NSNumber *stateBarStyle;
@end

@implementation MainWindowNavbar
...
- (void)setNeedsLayout
{
    ...
    if (!view) {
        ...
        _stateBarColor = [UIColor  colorWithRed:241 green:241 blue:241 alpha:1];
        view.backgroundColor =  [UIColor whiteColor];// (_stateBarColor)?_stateBarColor:DefaultStateBarColor;
...
- (id)initWithType:(NavBarButtonItemType)itemType
{
    ...
    if (self) {
        ...
        [button setTitleColor:ItemTextSelectedColot forState:UIControlStateNormal];
                      ...
                      title:(NSString *)title
{
    ...
    [item.button setBackgroundImage:[UIImage imageNamed:@"bar_background.png"] forState:UIControlStateNormal];
...
- (void)setNewTitle:(NSString *)title
{
    ...
    label.frame = CGRectMake(0, 0, 180, 24);
...
- (void)setNewTitleImage:(UIImage *)image
{
    ...
    UIImageView *imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"bar_logo.png"]];
    imageView.frame = CGRectMake(20,0, 100, 20);
                         ...
                         title:(NSString *)title
{
    ...
    buttonItem.font = [UIFont systemFontOfSize: 16.0];
